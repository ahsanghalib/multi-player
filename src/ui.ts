...
export class UI {
  ...
  mainWrapperContextMenu = (e: MouseEvent) => {
    ...
    const { clientWidth: contextWidth, clientHeight: contextHeight } =
      this.contextMenu;
  ...
  addVolumeControls = (parent: HTMLElement) => {
    ...
    this.controlsVolumeRangeInput.oninput = (e: any) =>
      Utils.onVolumeSliderChange(this, e);
  };
  ...
  addControlsProgressBar = () => {
    ...
    this.controlsProgressRangeInput.oninput = (e: any) =>
      Utils.onVideoProgressChange(this, e);
  };
  ...
  addControlsSetingsMenu = () => {
    ...
    if (this.optionsMenuState === SETTINGS_SUB_MENU.CC_SETTINGS) {
      ...
      const textSize: HTMLDivElement = this.create({
        ...
        parent: menu,
        className: "menu-item",
        innerHTML: `<div>Text Size</div><div>${
          Utils.getCloseCaptionStyles().textSize
        }</div>`,
      });
      ...
      const textColor: HTMLDivElement = this.create({
        ...
        parent: menu,
        className: "menu-item",
        innerHTML: `<div>Text Color</div><div>${
          Utils.getCloseCaptionStyles().textColor
        }</div>`,
      });
      ...
      const bgColor: HTMLDivElement = this.create({
        ...
        parent: menu,
        className: "menu-item",
        innerHTML: `<div>Background Color</div><div>${
          Utils.getCloseCaptionStyles().bgColor
        }</div>`,
      });
  ...
  addContextMenu = () => {
    ...
    img.alt = "Logo";
    this.create({ tag: "div", parent: item, className: "text" }).innerText =
      "Player";
  };
