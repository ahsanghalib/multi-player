...
declare namespace shaka.ads {
  class ServerSideAd implements shaka.extern.IAd {
    ...
    constructor(
      imaAd: google.ima.dai.api.Ad | null,
...
declare namespace shaka.net {
    ...
    implements shaka.util.IDestroyable
  {
     ...
     */
    constructor(
      onProgressUpdated?: (a: number, b: number) => any,
...
declare namespace cast.receiver {
  class CastReceiverManager {
    ...
    getCastMessageBus(
      namespace: string,
      messageType?: string,
    ): cast.receiver.CastMessageBus | null;
...
declare namespace chrome.cast {
  class ApiConfig {
    ...
    constructor(
      sessionRequest: chrome.cast.SessionRequest | null,
      sessionListener: Function | null,
      receiverListener: Function | null,
...
declare namespace google.ima.dai.api {
  class StreamManager implements EventTarget {
    ...
    constructor(
      ...
      uiSettings?: google.ima.dai.api.UiSettings | null,
    );
    addEventListener(
...
// Generated from /usr/local/google/home/joeyparrish/hacking/shaka/clean/externs/mux.js
declare namespace muxjs.mp4 {
  type ParsedClosedCaptions = {
    captionStreams: { [key: string]: boolean } | null;
...
declare namespace shaka.extern.ManifestParser {
  type PlayerInterface = {
    ...
    modifyManifestRequest: (
      a: shaka.extern.Request,
      b: shaka.util.CmcdManager.ManifestInfo,
    ) => any;
    modifySegmentRequest: (
      a: shaka.extern.Request,
      b: shaka.util.CmcdManager.SegmentInfo,
    ) => any;
