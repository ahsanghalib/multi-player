...
describe("UI Class", () => {
  ...
  test("addCloseCaptionContainer", () => {
    ...
    expect(ui.closeCaptionsContainer.className).toBe(
      "close-captions-container",
    );
  ...
  test("addVolumeControls", () => {
    ...
    expect(ui.controlsVolumeButton.parentElement).toBe(
      ui.controlsVolumeWrapper,
    );
  ...
  test("addControlsCloseCaptionMenu - if sub menu is cc", () => {
    ...
    expect(offCC.innerHTML).toBe(
      '<div class="menu-select"></div><div>Off</div>',
    );
  ...
  test("addControlsSetingsMenu", () => {
    ...
    const textSizeBackCC = getByRole(
      ui.optionsMenuWrapper,
      "back-to-cc-settings",
    );
    ...
    // text color
    const textColor = getByRole(
      ui.optionsMenuWrapper,
      "cc-settings-text-color",
    );
    expect(textColor).toBeTruthy();

    fireEvent.click(textColor);

    const textColorBackCC = getByRole(
      ui.optionsMenuWrapper,
      "back-to-cc-settings",
    );
    ...
    const textColorKeys = Object.keys(SETTINGS_CC_COLORS).map(
      (d) => `cc-settings-text-color-${d}`,
    );
    ...
    const bgColorKeys = Object.keys(SETTINGS_CC_COLORS).map(
      (d) => `cc-settings-bg-color-${d}`,
    );
    ...
    // bg opacity
    const bgOpacity = getByRole(
      ui.optionsMenuWrapper,
      "cc-settings-bg-opacity",
    );
    ...
    const bgOpacityBackCC = getByRole(
      ui.optionsMenuWrapper,
      "back-to-cc-settings",
    );
    ...
    // CHECK IN END...
    const backToSettingsFromCC = getByRole(
      ui.optionsMenuWrapper,
      "back-to-settings",
    );
  ...
  test("addContentNotAvailableWrapper", () => {
    ...
    expect(ui.contentNotAvailableWrapper.className).toBe(
