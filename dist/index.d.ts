declare module 'multi-players/airplay' {
  ...
  export class AirPlay {
      ...
      protected webkitCurrentPlaybackTargetIsWirelessChangedEvent: (airplay: HTMLDivElement, isLive: boolean, volume: HTMLDivElement) => (event: any) => void;
      init: () => void;
  }
...
declare module 'multi-players/index' {
  ...
  const player: {
      ...
      init: ({ elem, source, contextLogoUrl, config, eventCallbacks, onPauseCallback, onPlayCallback, onLeavePIPCallback, onEnterPIPCallback, onPlayerStateChange, }: {
          elem: HTMLDivElement;
...
declare module 'multi-players/shaka' {
  ...
  export class ShakaPlayer {
      ...
      buydrmFairplayRequestFilterImpl: (source: ISource) => (type: shaka.net.NetworkingEngine.RequestType, req: shaka.extern.Request) => any;
      buyDrmFairplayResponseFilterImpl: () => (type: shaka.net.NetworkingEngine.RequestType, resp: shaka.extern.Response) => any;
      vidgoResponseFilterImpl: () => (type: shaka.net.NetworkingEngine.RequestType, resp: shaka.extern.Response) => any;
...
declare module 'multi-players/ui' {
  ...
  export class UI {
      ...
      constructor();
      setContainer: (player: Player, elem: HTMLDivElement, contextLogoUrl?: string) => void;
      addElements: () => void;
      removeUI: () => void;
...
declare module 'multi-players/utils' {
  ...
  export class Utils {
      ...
      static toggleShowHide(elem: HTMLElement, show: 'flex' | 'block' | 'none'): void;
...
declare module 'multi-players/video.events' {
  ...
  export class VideoEvents {
      ...
      addEvents: () => void;
      removeEvents: () => void;
      getConfig: () => import("multi-players/types").IConfig;
      abortEvent: () => void;
      canPlayEvent: () => void;
